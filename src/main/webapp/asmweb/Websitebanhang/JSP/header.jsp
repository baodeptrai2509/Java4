 ...
 <header>
    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary sticky-top mb-1 p-3" style="background-color: #E5E5E5;">
        <div class="container-fluid">
            ...
            <a href=""><img src="asmweb/Websitebanhang/images/logo.jpg" alt="" class="img-fluid"></a>
            <div class="collapse navbar-collapse flex-grow-0" id="navbarNav">
                <ul class="navbar-nav">
                    <li class="nav-item dropdown dropdown-mega position-static">
                        <a href="asmweb/index.jsp" class="nav-link dropdown-toggle" role="button" data-bs-toggle="dropdown"aria-expanded="false"> 
                        <p> 
                                    Sofas</p>
                             </a>
                    ...
                    <li class="nav-item ">
                          ...
                          <a href="asmweb/user/index.jsp" class="list-group-item mt-2" style="font-weight: bold;">
                                                <p >Login</p>
                                                 </a>
                    </li>
                </ul>
            ...
            <ul>
                <a href="" class="icon-link" style="text-decoration: none;"><i class="bi bi-cart3 fs-3"></i></a>
            </ul>
        </div>
    </nav>
 </header>